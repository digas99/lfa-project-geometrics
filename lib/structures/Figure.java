...
public class Figure {
    ...
    public Figure(String id, Color color, Point center, boolean filled, double thickness, boolean display, boolean container) {
        this.id = id;
        this.color = color;
        this.center = center;
        this.filled = filled;
    ...
    @Override public String toString() {
        return String.format("[%s] \ncolor: %s; \ncenter: %s; \nthickness: %.2f; \n%s; \n%s; \n%s; \nhas %d figures", this.id, this.color, this.center.print(), this.thickness, this.container ? "container" : "!container", this.filled ? "filled" : "!filled", this.display ? "visible" : "!visible", this.figures.size());
    }
}
